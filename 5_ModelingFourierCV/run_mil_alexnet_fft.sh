#!/bin/bash
# ================================================================
# run_mil_alexnet_fft.sh
# ------------------------------------------------
# Launches MIL training (AlexNet1D + FFT amplitudes) inside a tmux session
# Environment: shdb-af-analysis
# Script: train_mil_alexnet_fft.py
# ================================================================

SESSION_NAME="mil_train_alexnet_fft"
