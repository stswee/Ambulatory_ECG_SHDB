...
# Script: train_mil_alexnet_crossattn.py
# GPU: CUDA_VISIBLE_DEVICES=3
# ================================================================

SESSION_NAME="mil_alexnet_crossattn"
...
LOGFILE="$LOG_DIR/mil_alexnet_crossattn_${TIMESTAMP}.log"

# Training parameters
EPOCHS=10
BATCH_SIZE=1
LR=1e-4
SCRIPT_NAME="train_mil_alexnet_crossattn.py"
...
tmux send-keys "echo 'Launching Cross-Attention MIL EfficientNet training on GPU 3... Logs at $LOGFILE'" C-m
tmux send-keys "python $SCRIPT_NAME --epochs $EPOCHS --batch_size $BATCH_SIZE --lr $LR --mixed_precision | tee $LOGFILE" C-m

echo "Training started inside tmux session '$SESSION_NAME' (GPU 3)."
