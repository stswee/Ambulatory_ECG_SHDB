#!/bin/bash
# ================================================================
# run_mil_efficientnet1d_crossattn.sh
# ------------------------------------------------
...
LOGFILE="$LOG_DIR/mil_efficientnet1d_crossattn_${TIMESTAMP}.log"

# Training parameters
EPOCHS=10
BATCH_SIZE=1
LR=1e-4
SCRIPT_NAME="train_mil_efficientnet1d_cv_crossattn.py"
...
tmux send-keys "echo 'Launching Cross-Attention MIL EfficientNet1D training on GPU 1... Logs at $LOGFILE'" C-m
